...
import com.caching.CaffeineExample.service.CustomerService;
...
public class CaffeineCacheApp implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        customerService.getCustomer(2l); //hit , since it is already in the cache.
        customerService.getCustomer(1l); //hit , since it is already in the cache.
        customerService.getCustomer(3l); //hit , since it is already in the cache.
    }
}